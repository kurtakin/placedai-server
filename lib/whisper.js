...
// Model takibi (lib/model-takip.js) bu kimlikleri de saglayici listesiyle
// karsilastirir: ses yazma yolunun modelleri de emekli olabilir.
const SES_MODELLERI = PROVIDERS.map((p) => ({ gorev: p.name === 'Groq' ? 'groq_ses_yazma' : 'yedek_ses_yazma', model: p.model }));

module.exports = { transcribeBase64, SES_MODELLERI };
