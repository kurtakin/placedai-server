...
t('kapi: coding ucretli katmanlarda, free\'de degil', () => {
  ...
  assert.strictEqual(planAllows('multi', 'coding'),    true);
...
t('eski multi paketi coding gorur, Ultimate ozelliklerini gormez', () => {
  assert.strictEqual(planAllows('multi', 'coding'),      true);
  assert.strictEqual(planAllows('multi', 'performance'), false);
});
